  ...
  PUBLIC SECTION.
    ...
    TYPES:
      ...
      BEGIN OF tys_a_enterprise_project_type,
        ...
        "! EntProjHasProjectStockEnabled_fc
        ent_proj_has_project_stock TYPE int1,
        ...
        ent_proj_has_project_sto_2 TYPE abap_bool,
...
CLASS ZCL_PRA_MF_SCM_ENT_PROJ IMPLEMENTATION.
  ...
  METHOD def_a_enterprise_project_type.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'ENT_PROJ_HAS_PROJECT_STOCK' ).
    lo_primitive_property->set_edm_name( 'EntProjHasProjectStockEnabled_fc' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Byte' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'ENT_PROJ_HAS_PROJECT_STO_2' ).
    lo_primitive_property->set_edm_name( 'EntProjHasProjectStockEnabled' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

  ...
  METHOD createproject.
    ...
    IF lt_event_data IS NOT INITIAL.
      ...
      IF lt_proj_message IS NOT INITIAL.
        ...
        DATA(message_id) = lt_proj_message[ 1 ]-id.
        DATA(message_number) = lt_proj_message[ 1 ]-number.
        MESSAGE ID message_id TYPE 'E' NUMBER message_number INTO DATA(error_text).
